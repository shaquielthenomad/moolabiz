    ...
    <main className="min-h-screen bg-canvas text-ink">
      ...
      <section className="bg-white px-6 pt-20 pb-24 text-center">
        <div className="max-w-3xl mx-auto">
          <div className="inline-flex items-center gap-2 bg-moola-tint text-moola-deep text-xs font-semibold px-3.5 py-1.5 rounded-full mb-8 tracking-wide border border-moola-tint">
            Howzit! Built for South African sellers
          </div>

          <h1 className="text-5xl sm:text-6xl font-bold text-ink leading-tight tracking-tight">
            Your WhatsApp store.<br />
            <span className="text-moola-deep">Always open.</span>
          </h1>

          <p className="mt-6 text-lg sm:text-xl text-ink-muted max-w-xl mx-auto leading-relaxed">
          ...
          <div className="mt-10 flex flex-col sm:flex-row items-center justify-center gap-3">
            <a
              href="#signup"
              className="w-full sm:w-auto bg-primary hover:bg-primary-hover text-white font-semibold text-base px-8 py-3.5 rounded-xl shadow-sm transition-colors"
            >
              Start selling &rarr;
            </a>
            <a
              href="#how-it-works"
              className="w-full sm:w-auto border border-hairline-strong hover:border-ink-muted text-ink font-semibold text-base px-8 py-3.5 rounded-xl transition-colors"
            >
              See how it works
            </a>
          </div>

          <p className="text-sm text-ink-muted mt-4 flex items-center justify-center gap-2">
      ...
      <section className="bg-white py-24 px-6 text-center">
        <div className="max-w-xl mx-auto">
          ...
          <div className="mt-8">
            <a
              href="#signup"
              className="inline-block bg-primary hover:bg-primary-hover text-white font-semibold text-base px-10 py-4 rounded-xl shadow-sm transition-colors"
            >
              Start selling &rarr;
            </a>
          </div>
      ...
      <footer className="border-t border-hairline py-10 px-6">
        <div className="max-w-screen-xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-4 text-sm text-ink-muted">
          ...
          <div className="flex items-center gap-6">
            ...
            <a href="mailto:support@moolabiz.shop" className="hover:text-ink-muted transition-colors">Contact</a>
          </div>
    ...
    >
      ...
      <div>
        ...
        <input
          ...
          className="block w-full rounded-xl border border-hairline-strong px-4 py-3 text-ink placeholder:text-ink-muted focus:border-emerald-500 focus:ring-2 focus:ring-emerald-200 outline-none text-base transition-colors"
        />
      </div>
      ...
      <div>
        ...
        <select
          ...
          className="block w-full rounded-xl border border-hairline-strong px-4 py-3 text-ink bg-white focus:border-emerald-500 focus:ring-2 focus:ring-emerald-200 outline-none text-base transition-colors"
        >
          ...
          <form onSubmit={handleWaitlistSubmit} className="space-y-4">
            <div>
              ...
              <input
                ...
                className="block w-full rounded-xl border border-hairline-strong px-4 py-3 text-ink placeholder:text-ink-muted focus:border-amber-500 focus:ring-2 focus:ring-amber-200 outline-none text-base transition-colors"
              />
            </div>
            <button
              type="submit"
