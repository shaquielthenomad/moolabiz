...
export const SITE_NAME = process.env.NEXT_PUBLIC_SITE_NAME || 'MoolaBiz Store';
export const SITE_URL = process.env.NEXT_PUBLIC_SITE_URL || 'https://store.moolabiz.shop';
